...
class Window(QWidget):
    ...
    def __init__(self,parent=None):
        ...
        self.target_network_address.setPlaceholderText("(Target Address)")
        ...
        #
        self.ping_count_label        = QLabel("Subnet Mask")
        ...
        self.vertical_button_box.addWidget(self.tableWidget)
        #
        ...
        #
        self.ping_button.clicked.connect(self.InitializeHosts)
    ...
    def InitializeHosts(self):
        try:
            ...
            for h in self.hosts_to_scan:
                entry = [h,'UP']
                self.AddTableRow(self.tableWidget,entry)
                logging.info('%s' % h)
        except Exception as e:
            logging.info('%s' % e)
            sys.exit(1)
